...
ENV FLINK_TGZ_URL=https://archive.apache.org/dist/flink/flink-1.20.4/flink-1.20.4-bin-scala_2.12.tgz \
    FLINK_ASC_URL=https://archive.apache.org/dist/flink/flink-1.20.4/flink-1.20.4-bin-scala_2.12.tgz.asc \
...
# Configure container
COPY ajam runjob runp docker-entrypoint.sh /
RUN /ajam /opt/flink/bin/curl:curl  /opt/flink/bin/hurry:darkhttpd /opt/flink/bin/jq:jq && /runp s3-fs-presto
